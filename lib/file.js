...
/**
 * Changes the create, modify and access times of a specific file.
 *
 * @param {string} filepath Full path to the file.
 * @param {string|Date} date Javascript Date object or parsable date to use.
 * @return {Promise} A Promise.
 */
file.changeCreateTime = function(filepath, date) {
  return new Promise(function(resolve, reject) {
    var dt = moment(date);

    var spaceEscapedFilepath = filepath.replace(' ', '\\ ');

    var cmd = 'touch -mt ';
    cmd += dt.format('YYYYMMDDHHmm.ss');
    cmd += ' ' + spaceEscapedFilepath;
